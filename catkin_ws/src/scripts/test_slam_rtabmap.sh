...
#xterm -e "cd $SCRIPT_ROOT_DIRECTORY/../..; source devel/setup.bash; rosrun rtabmap_ros rtabmap" &
xterm -e "cd $SCRIPT_ROOT_DIRECTORY/../..; source devel/setup.bash; roslaunch launchfiles mapping.launch" &
sleep 3

# https://answers.ros.org/question/217097/export-2d-map-from-rviz-andor-rtab-map/?answer=217100#post-id-217100
xterm -e "cd $SCRIPT_ROOT_DIRECTORY/../..; source devel/setup.bash; rosrun map_server map_saver" &
# TO SAVE THE 2-D MAP:
